...
import com.foodapp.foodapp.exception.productExcept.*;
...
public class ProductValidation {
    ...
    public static void productFormatUuid(String uuidProduct){
        try {
    ...
    public static void productFantasyNameUUIDValidation(Optional<ProductEntity> otherProduct, String uuid){
